...
from .views import OtpUpdateView, UserDetailView, UserWinUpdateView, UserLoseUpdateView, FriendView, logout, test_friend, SingleGameRecordListView, FriendDetailView
